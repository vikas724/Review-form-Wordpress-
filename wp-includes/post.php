...
function my_custom_meta_boxes() {
  add_meta_box('review_form', 'Review Form', 'review_form_callback', 'post', 'side');
}

function review_form_callback($post) {
  $checked = get_post_meta($post->ID, 'enable_review_form', true);
?>
<input type="checkbox" name="enable_review_form" value="1" <?php checked($checked, 1); ?>> Enable Review Form
<?php
}
