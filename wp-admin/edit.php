...
function my_custom_column_content($column_name, $post_id) {
    if ($column_name === 'reviews') {
        // Your logic to display content in the "Reviews" column goes here
        // You can fetch and display the review content for the post/page using $post_id
        // For example:
        $reviews = get_post_meta($post_id, 'reviews_meta_key', true);
        echo $reviews;
    }
}
